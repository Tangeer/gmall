package com.longrise.gmall.mock;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.longrise.gmall.mock.util.*;
...
public class JsonMocker {
    ...
    String appId = "gmall20181020";

    RanOpt[] vsOpts = {new RanOpt("1.2.0", 50),
            new RanOpt("1.1.2", 15),
            new RanOpt("1.1.3", 30),
            new RanOpt("1.1.1", 5)
    };

    RandomOptionGroup<String> vsOptionGroup = new RandomOptionGroup<String>(vsOpts);

    RanOpt[] eventOpts = {new RanOpt("addFavor", 10),
            new RanOpt("addComment", 30),
            new RanOpt("addCart", 20),
            new RanOpt("clickItem", 40)
    };

    RandomOptionGroup<String> eventOptionGroup = new RandomOptionGroup<String>(eventOpts);

    RanOpt[] channelOpts = {new RanOpt("xiaomi", 10),
